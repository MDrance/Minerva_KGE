...
gpu_id=3
ARGS=${@:2}
cmd="python3 src/model/trainer.py --base_output_dir $base_output_dir --path_length $path_length --hidden_size $hidden_size --embedding_size $embedding_size \
    ...
    --nell_evaluation $nell_evaluation --emb_dir $emb_dir $ARGS"
